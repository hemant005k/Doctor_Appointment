        ...
        resolve:{
            ...
            deps:['$ocLazyLoad',function($ocLazyLoad){
                return $ocLazyLoad.load({
                    name:'MetronicApp',
                    insertBefore:'#ng_load_plugins-before',
                    files:[
     ...
     .state('app',{
        ...
        resolve:{
            deps:['$ocLazyLoad',function($ocLazyLoad){
                return $ocLazyLoad.load({
                    name:'MetronicApp',
                    insertBefore:'#ng-load_plugins-before',
                    files:[
...
//                            'assets/admin/pages/scripts/tasks.js',
     ...
     .state('app.hospital', {
        ...
        .state('app.petients', {
            url: "/listofpet.html",
            templateUrl: "views/listofpet.html",
            data: {pageTitle: 'Petients List'},
            controller: "PetientsController",
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
                        name: 'MetronicApp',
                        ...
                        files: [
                            ...
                            'js/controllers/PetientsController.js'
                        ] 
                    }]);
                }] 
            }
            ...
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
                        ...
                        insertBefore: '#ng_load_plugins_before', // load the above css files before 
                        files: [
                            'assets/admin/pages/css/calenderinline.css',
                            'assets/admin/pages/css/calen.css',
                            
//                            'assets/admin/pages/scripts/calenderinline.js',
                            'assets/admin/pages/scripts/cal.js',
                            'js/controllers/CalenderController.js'
                        ] 
                    }]);
                }] 
            }
         ...
         .state('app.exsist', {
                url: "/exsisting.html",
                templateUrl: "views/exsisting.html",
                data: {pageTitle: 'Exsist'},
                controller: "ExsistingController",
                resolve: {
                    deps: ['$ocLazyLoad', function($ocLazyLoad) {
                        return $ocLazyLoad.load([{
                            name: 'MetronicApp',
                            files: [
                                ...
                                'js/controllers/ExsistingController.js'
                            ] 
                        }]);
                    }] 
                }
...
//            .state('app.newA', {
//                        url: "/newAva.html",
//                        templateUrl: "views/newAva.html",
//                        data: {pageTitle: 'NewAvalibility'},
//                        controller: "NewAController",
//                        resolve: {
//                            deps: ['$ocLazyLoad', function($ocLazyLoad) {
//                                return $ocLazyLoad.load([{
//                                    name: 'MetronicApp',
...
//                                            'js/controllers/NewAController.js'
//                                    ] 
//                                }]);
//                            }] 
//                        }
//                    })
    ...
    .state('app.newA', {
                    ...
                    return $ocLazyLoad.load([{
                        ...
                        files: [
                            ...
                            'assets/admin/pages/scripts/components-form-tools.js',
                             'assets/admin/pages/scripts/component-form-tool2.js',
                            'assets/admin/pages/scripts/components-pickers.js',
                            'js/controllers/NewAController.js'
                        ] 
                    }]);
     ...
     .state('app.createAvalibility', {
            url: "/createAvalibility.html",
            templateUrl: "views/createAvalibility.html",
            data: {pageTitle: 'Avalibility'},
